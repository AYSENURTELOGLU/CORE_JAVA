...
public class C04_ElementSay {
    ...
    public static void elemanSay(int[] arr, int arananSayi){ //döndürme yok yazdırma var o yüzden void
        ...
        if (sayac==0){
            ...
            System.out.println("aranan" + arananSayi+" sayısı array de" + sayac+" kullanıldı");
        }
