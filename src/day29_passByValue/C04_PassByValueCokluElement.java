...
public class C04_PassByValueCokluElement {
  ...
  - eger method'lar arasindaki gecisi yapan coklu element iceren bir yapi ise
    ...
    * ancak objenin kendisine yeni bir deger atamasi yapilirsa
    ...
    /* verilen bir int arrayin elementlerinin 2 katına çıkarıp
    ...
    public static void main(String[] args) {
        ...
        System.out.println("main methodda call dan önce arr: " + Arrays.toString(arr));

        elementleriArtir(arr);

        System.out.println("main method call dan sonra arr: " + Arrays.toString(arr));

        /*
        verieln array e 10 değerini element olarak ekleyip
        ...
        System.out.println("main methodda call dan önce arr: " + Arrays.toString(arr2));

        elementEkle(arr2);

        System.out.println("main method call dan sonra arr: " + Arrays.toString(arr2));
    ...
    public static void elementleriArtir(int[] arr){
        ...
        System.out.println("method da değiştrilen arr: " + Arrays.toString(arr));
    }
