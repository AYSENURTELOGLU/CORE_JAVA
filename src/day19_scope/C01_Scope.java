...
public class C01_Scope {
    ...
    static int classLevvelStatic=12;
    String strClassLevelStaticOlmayan="Java Güzeldir";

    //variable lar local içinde class level variableer olarak iki türlüdür
    // local olanlar 2 ye ayrılır.1 local variable 2- loop variable
    //class levellar da 2 ye ayrılır: 1- static variavle 2- instance variable
